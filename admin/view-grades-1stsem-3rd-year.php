...
if (strlen($_SESSION['login']) == 0) {
    ...
    $query_student = mysqli_query($con, "SELECT * FROM tblstudents WHERE student_id='$student_id' AND student_year='3rd Year'");
    ...
    if (isset($_GET['delete_id'])) {
        ...
        echo "<script>window.location.href='view-grades-1stsem-3rd-year.php?student_id=$student_id';</script>";
        exit();
    }
    ...
    if (isset($_POST['update_grade'])) {
        ...
        echo "<script>window.location.href='view-grades-3rd-year.php?student_id=$student_id';</script>";
        exit();
    }
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Grades for <?php echo htmlentities($student['student_name']); ?> (1st Semester - 3rd Year)</h4>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <a href="1stsem-3rd-year-grades.php" class="btn btn-danger">Back</a>
