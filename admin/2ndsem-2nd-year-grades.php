                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="2ndsem-2nd-year-grades.php?delete_id=<?php echo htmlentities($row['student_id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this student\'s grades?');">
                                                Delete
                                            </a>
                                        </td>
                                    </tr>
