                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach ($courses as $course) {
                                    ...
                                    $grade = $grade_data ? intval($grade_data['grade']) : 0;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post">
                                                ...
                                                <input type="number" name="grade" class="form-control grade-input" value="<?php echo $grade_data ? htmlentities($grade_data['grade']) : ''; ?>" min="0" max="100">
                                        </td>
                                        <td id="remarks-<?php echo htmlentities($course_no); ?>"><?php echo $remarks; ?></td>
...
<script>
    ...
    document.querySelectorAll(".grade-input").forEach(input => {
        input.addEventListener("input", function() {
            var courseNo = this.closest("tr").querySelector("td:first-child").innerText;
            var grade = parseFloat(this.value);
            var remarksCell = document.getElementById("remarks-" + courseNo);
