...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_GET['delete_id'])) {
        ...
        echo "<script>window.location.href='view-grades-2ndsem-3rd-year.php?student_id=$student_id';</script>";
        exit();
    }
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Grades for <?php echo htmlentities($student['student_name']); ?> (2nd Semester - 3rd Year)</h4>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <a href="2ndsem-3rd-year-grades.php" class="btn btn-danger">Back</a>
