<div id="grade-form-3rd">
    ...
    <form method="post" id="grade-entry-form-3rd">
        ...
        <input type="hidden" name="year_form[]" value="3">
    ...
    $(document).ready(function() {
        ...
        function loadCourses() {
            ...
            courses["1st Sem"].forEach((course, index) => {
                tbody1st.append(createTableRow(course, `3-1-${index}`, "1st Sem"));
            });

            courses["2nd Sem"].forEach((course, index) => {
                tbody2nd.append(createTableRow(course, `3-2-${index}`, "2nd Sem"));
            });
