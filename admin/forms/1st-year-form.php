    ...
    $(document).ready(function() {
        var courses = {
            "1st Sem": [{
                ...
                {
                    course_no: "PE-1",
                    title: "PATH FIT 1 - Movement Enhancement",
                    unit: 2,
                    pre_req: "None"
                },
                {
            ...
            "2nd Sem": [{
                ...
                {
                    course_no: "GEC-9",
                    title: "Filipino 1 - Komunikasyon sa Akademikong Filipino",
                    unit: 3,
                    pre_req: "None"
                },
                {
                    course_no: "PE-2",
                    title: "PATH FIT 2 - Exercise-based Fitness Activities",
                    unit: 2,
                    pre_req: "PE-1"
                },
                {
        ...
        function loadCourses() {
            ...
            courses["1st Sem"].forEach((course, index) => {
                tbody1st.append(createTableRow(course, `1-1-${index}`, "1st Sem"));
            });

            courses["2nd Sem"].forEach((course, index) => {
                tbody2nd.append(createTableRow(course, `1-2-${index}`, "2nd Sem"));
            });
