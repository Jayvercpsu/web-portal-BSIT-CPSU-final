            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">1st Year - 1st Semester Grades</h4>
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                $query = mysqli_query($con, "SELECT DISTINCT student_id, student_name FROM tblgrades WHERE student_year='1st Year' AND semester='1st Sem' ORDER BY student_name ASC");
                                $cnt = 1;
