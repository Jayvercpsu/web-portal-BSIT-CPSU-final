<?php
    ...
    // Fetch all students from the 'first_year' table
    $students_query = mysqli_query($con, "SELECT * FROM first_year ORDER BY id ASC");
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">First Year Students</h4>
                            <ol class="breadcrumb p-0 m-0">
                                <li><a href="#">Dashboard</a></li>
                                <li class="active">First Year Students</li>
                            </ol>
