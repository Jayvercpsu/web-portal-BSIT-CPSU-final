<?php
    ...
    // Fetch all students from the 'third_year' table
    $students_query = mysqli_query($con, "SELECT * FROM third_year ORDER BY id ASC");
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Third Year Students</h4>
                            <ol class="breadcrumb p-0 m-0">
                                <li><a href="#">Dashboard</a></li>
                                <li class="active">Third Year Students</li>
                            </ol>
