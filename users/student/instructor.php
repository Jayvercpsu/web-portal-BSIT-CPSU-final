                            ...
                            <div class="col-lg-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4 wow zoomIn">
                                        <div class="card-doctor">
                                            <div class="header">
                                                <img src="../../assets/faculty_image/nino.jpg" alt="">
                                                <div class="meta">
                                                    <a href="https://facebook.com" target="_blank" class="text-dark">
                                                        <i class="fab fa-facebook-f"></i>
                                                    </a>
                                            ...
                                            <div class="body">
                                                <p class="text-xl mb-0">Nino Hayagan</p>
                                                <span class="text-sm text-grey">Program Head</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4 wow zoomIn">
                                        <div class="card-doctor">
                                            <div class="header">
                                                <img src="../../assets/faculty_image/paulo.jpg" alt="">
                                                <div class="meta">
                                                    <a href="https://facebook.com" target="_blank" class="text-dark">
                                                        <i class="fab fa-facebook-f"></i>
                                                    </a>
                                            ...
                                            <div class="body">
                                                <p class="text-xl mb-0">Paulo Lumanog</p>
                                                <span class="text-sm text-grey">Instructor</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4 wow zoomIn">
                                        <div class="card-doctor">
                                            <div class="header">
                                                <img src="../../assets/faculty_image/dino.jpg" alt="">
                                                <div class="meta">
                                                    <a href="https://facebook.com" target="_blank" class="text-dark">
                                                        <i class="fab fa-facebook-f"></i>
                                                    </a>
                                            ...
                                            <div class="body">
                                                <p class="text-xl mb-0">Dino Agraviador</p>
                                                <span class="text-sm text-grey">Instructor</span>
                                            </div>
                                        </div>
                                    </div>
