...
// Fetch professors who match the student's year level from the professors table
$query = mysqli_query($con, "SELECT * FROM professors WHERE year_level = '$year_level'");
