    ...
    <div id="carouselExample" class="carousel slide" data-ride="carousel" data-interval="3000">
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <div class="page-hero bg-image overlay-dark" style="background-image: url('assets/images/sample_bsit.jpg');">
            ...
            <div class="carousel-item">
                <div class="page-hero bg-image overlay-dark" style="background-image: url('assets/images/sample2.jpg');">
                    <div class="hero-section d-flex align-items-center">
                        <div class="container text-center text-white wow zoomIn mt-5">
            ...
            <!-- Third Slide -->
            <div class="carousel-item">
                <div class="page-hero bg-image overlay-dark" style="background-image: url('assets/images/whole.jpg');">
                    <div class="hero-section d-flex align-items-center">
                        <div class="container text-center text-white wow zoomIn mt-5">
            ...
            <div class="row align-items-center" style="padding-bottom: 40px;">
                ...
                <div class="col-lg-6 wow fadeInRight" data-wow-delay="400ms">
                    <div class="img-place custom-img-1">
                        <img src="assets/images/sample2.jpg" alt="CPSU Students">
                    </div>
                </div>
            </div>
        </div>
